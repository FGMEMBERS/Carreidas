...
#
    ...
    var s_pos =props.globals.initNode("instrumentation/radar[1]/switch-pos",0,"INT");
    var r_rng =props.globals.initNode("instrumentation/radar[1]/range",10,"DOUBLE");
    var r_sw =props.globals.initNode("instrumentation/radar[1]/switch","off");
